...
@Aspect
@Component
@Profile("perf") // pour que cet aspect ne soit activé qu'avec le profil perf au démarrage du main ou des tests
public class MyPerfLogAspect {
	...
	@Pointcut("execution(* com.inetum.appliSpringWeb.*.*(..))")
	...
	//@Around("execution(* com.inetum.appliSpringWeb.service.*.*(..))")
