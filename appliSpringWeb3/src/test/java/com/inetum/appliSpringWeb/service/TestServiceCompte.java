...
public class TestServiceCompte {
	...
	public void testBonTransfert(){
			...
			Compte cptA = serviceCompte.saveOrUpdate(new Compte(null,"compteA", 50.00));
			Compte cptB = serviceCompte.saveOrUpdate(new Compte(null,"compteB", 250.00));
	...
	public void testMauvaisTransfert() {
		Compte cptA = serviceCompte.saveOrUpdate(new Compte(null,"compteAA", 40.00));
		Compte cptB = serviceCompte.saveOrUpdate(new Compte(null,"compteBB", 550.00));
